...
class login:
    ...
    def register(self):
        ...
        self.passwordr1 = Label(self.frame, text='Create Password : ', bg='Orange', fg='Green',
                                font=('Arial', 14, 'bold'))
        ...
        self.passwordr2 = Label(self.frame, text='Reenter Password : ', bg='Orange', fg='Green',
                                font=('Arial', 14, 'bold'))
    ...
    def create(self):
        if self.passwordr1e.get() != self.passwordr2e.get():
            ...
            backend_loginPage.insert(self.namere_text.get(), self.passwordr1e_text.get())
    ...
    def login_admin(self):
        if len(self.namee.get()) == 0:
            ...
            backend_loginPage.check(self.namee_text.get(), self.password1e_text.get())
    ...
    def login_student(self):
        if len(self.namee.get()) == 0:
            ...
            backend_loginPage.checks(self.namee_text.get(), self.password1e_text.get())
